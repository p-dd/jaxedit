...
(function(){
    ...
    var renderers = {
      cmdHref: function(node) {
        ...
        var url = argarray[1].childs[0] !== undefined ? argarray[1].childs[0].value : "";
        var text = argarray[2].childs[0] !== undefined ? argarray[2].childs[0].value : "";
        node.childs = [];
      ...
      cmdUrl: function(node) {
        ...
        //console.log(argarray);
        var url = argarray[0].childs[0] !== undefined ? argarray[0].childs[0].value : "";
        node.childs = [];
